...
export default function LoginPage() {
  ...
  const getErrorMessage = (error: string) => {
    const errorMappings: Record<string, string> = {
      'Invalid credentials': 'Credenciales incorrectas. Inténtelo de nuevo.',
      ...
      'Network error occurred': 'No se pudieron verificar las credenciales. Revise su conexión.',
    };
        ...
        >
          ...
          >
            ...
            <Typography variant="h6" sx={{ opacity: 0.9 }}>
              LOS ESTADOS UNIDOS DE KICSLAND
            </Typography>
            ...
            >
              {`+========================================+
|%%%%%%%  NOTA DE RESERVA NACIONAL  %%%%%%%%|
|%(1)  LOS ESTADOS UNIDOS DE KICSLAND (1)%|
|%$$              ___       ********  $$%|
|%$    {x}       (o o)                 $%|
|%$     ******  (  V  )      UNO       $%|
|%(1)          ---m-m---             (1)%|
...
+========================================+`}
          ...
          <Box sx={{ p: 4 }}>
            <Typography
              ...
              sx={{ mb: 3 }}
            >
              Ingrese su ID de usuario y contraseña, luego presione ENTRAR:
            </Typography>
            ...
            >
              ...
              >
                {isLoading ? 'Iniciando sesión...' : 'ENTRAR = Iniciar sesión'}
              </Button>
              </Stack>
            </Box>
            ...
            <Box sx={{ textAlign: 'center' }}>
              ...
              <Stack direction="row" spacing={2} justifyContent="center" flexWrap="wrap">
                ...
                <Typography variant="caption" sx={{ 
                  ...
                  Oficina administrativa: USER001 / PASSWORD
                </Typography>
              </Stack>
            </Box>
          </Box>
          ...
          >
            <Typography variant="body2" color="text.secondary">
              ENTRAR = Iniciar sesión • F3 = Salir
            </Typography>
          </Box>
        </Paper>
      </Box>
